...
<!-- SPECKIT START -->
**Active feature**: `010-open-shifts`
**Plan**: [specs/010-open-shifts/plan.md](specs/010-open-shifts/plan.md)
...
`007-availability`, `008-time-off`, `009-publish-workflow` shipped.
<!-- SPECKIT END -->
