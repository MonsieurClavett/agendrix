...
<!-- SPECKIT START -->
**Active feature**: `013-shift-swaps`
**Plan**: [specs/013-shift-swaps/plan.md](specs/013-shift-swaps/plan.md)
...
`010-open-shifts`, `011-email-invitations`, `012-notifications` shipped.
<!-- SPECKIT END -->
